...
funambol.subitosms.util.FILOArray = function () {
    this.numbers = new Array();
    if (funambol.subitosms.util.FILOArray.arguments.length > 0) {
        this.maxSize = funambol.subitosms.util.FILOArray.arguments[0];
    } else {
        this.maxSize = 20;
    }
}

funambol.subitosms.util.FILOArray.prototype.isEmpty = function() {
    return this.numbers.length == 0;
}

funambol.subitosms.util.FILOArray.prototype.getMaxSize = function() {
    return this.maxSize;
}

funambol.subitosms.util.FILOArray.prototype.getSize = function() {
 ...
 */
funambol.subitosms.util.FILOArray.prototype.add = function(entry) {
    //
 ...
 */
funambol.subitosms.util.FILOArray.prototype.get = function(index) {
    if (index < 0) {
 ...
 * the array.
 */
funambol.subitosms.util.FILOArray.prototype.toString = function() {
 ...
 */
funambol.subitosms.util.FILOArray.prototype.fromString = function(s) {
    if (s.length == 0) {
        this.numbers = new Array();
    } else {
